...
if __name__=='__main__':
    ...
    callbacks = [
        ...
        EarlyStopping(monitor="val_bleu", min_delta=0.000, patience=10, verbose=False, mode="max"),
        # StochasticWeightAveraging(swa_lrs=1e-2)
    ]

    logger = CSVLogger(save_dir="/scratch/ss4yd/logs_only_resnet/", name="my_model")
