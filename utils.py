...
pretrained_weights256 = '../HIPT/HIPT_4K/Checkpoints/vit256_small_dino.pth'
pretrained_weights4k = '../HIPT/HIPT_4K/Checkpoints/vit4k_xs_dino.pth'
...
def create_attention_maps(region, model4k):

    model256=load_model256()
    print("Generating attention maps")
    
    light_jet = cmap_map(lambda x: x/2 + 0.5, matplotlib.cm.jet)

    output_dir = './4k_output_indiv/'
...
def caption_image_beam_search(encoder, decoder, image, word_map, device, beam_size=3):
    """
...
def return_string_list(references_str):
